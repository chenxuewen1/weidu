 ...
 *Description:品质生活
 */
public class QualityAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context context;
    private List<ShowBean.ResultBean.PzshBean.CommodityListBeanX> list;

    public QualityAdapter(Context context, List<ShowBean.ResultBean.PzshBean.CommodityListBeanX> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.quality_adapter_layout,null,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.quality_adapter_image);
            name = itemView.findViewById(R.id.quality_adapter_name);
            price = itemView.findViewById(R.id.quality_adapter_price);
        }
    }
    //定义接口
