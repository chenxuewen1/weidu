...
public class MagicAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public MagicAdapter(Context context, List<ShowBean.ResultBean.MlssBean.CommodityListBeanXX> list) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view=LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.magic_adapter_layout,null,false);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder{
        ...
        public MyViewHolder(@NonNull View itemView) {
            super(itemView);
            image = itemView.findViewById(R.id.magic_adapter_image);
            name = itemView.findViewById(R.id.magic_adapter_name);
            price = itemView.findViewById(R.id.magic_adapter_price);
        }
    }
    //定义接口
